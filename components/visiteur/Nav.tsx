    ...
    <View style={[styles.headerNav, isDarkMode && styles.darkMode]}>
      ...
      <View style={styles.navCtn}>
        ...
        >
          ...
          <TouchableOpacity
            style={styles.navItem}
            onPress={() => navigation.navigate("HomeVisiteur")}
          >
          ...
          >
            <Text style={styles.navLink}>Mes résultats</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.navItem}
            onPress={() => navigation.navigate("Probleme")}
          >
            <Text style={styles.navLink}>Problème</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.navItem}
            onPress={() => navigation.navigate("RoomTour")}
          >
            <Text style={styles.navLink}>Room tour</Text>
          </TouchableOpacity>
        </View>
